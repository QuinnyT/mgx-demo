...
import { Plus, Send, Loader2, MessageSquare, History, ChevronLeft, ChevronRight, Code, Monitor, Menu } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Conversations Sidebar - 参照 Index.tsx 的实现 */}
        <aside 
          className={cn(
                  ...
                  <div className="space-y-1">
                    {conversations.map((conv) => (
                      <button
                        ...
                        className={cn(
                          'flex w-full flex-col gap-1 rounded-xl px-3 py-2 text-left text-sm text-slate-700 transition-colors hover:bg-slate-100',
