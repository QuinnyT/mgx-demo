...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col justify-center bg-gradient-to-br from-[#f8f5ff] via-white to-[#f1f5ff] px-6 py-10 lg:flex-row lg:items-center lg:px-12">
      <div className="flex flex-1 flex-col items-center gap-10 text-center lg:items-start lg:text-left">
        ...
        <div className="relative mx-auto w-full max-w-xl overflow-hidden rounded-3xl bg-gradient-to-tr from-[#f1e6ff] via-white to-[#e0f2ff] p-8 shadow-[0_30px_80px_-40px_rgba(79,70,229,0.45)] lg:mx-0">
